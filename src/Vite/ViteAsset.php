...
final class ViteAsset implements ContainerInjectionInterface {
   ...
   * @param \Drupal\rapid\Vite\ViteManifest $manifest
   *   The vite manifest.
   * @param \Drupal\rapid\Vite\ViteMode $mode
   *   The vite mode.
   * @param \Drupal\rapid\Vite\ViteServer $server
   *   The vite server.
   */
